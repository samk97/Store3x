...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center   justify-between gap-2 p-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className=" pt-4 ">
          <div>
            <h3 className="mb-4 pb-2 ml-4   text-sm font-semibold text-bodydark2">
              MENU
            </h3>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("dashboard2")
                }
              >
                {(handleClick, open) => {
                  return (
